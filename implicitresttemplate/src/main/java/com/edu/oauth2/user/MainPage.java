...
public class MainPage {
    ...
    @GetMapping("/callback")
    public ModelAndView callback(@RequestParam String accessToken, @RequestParam(required = false) String state,@RequestParam String tokenType,@RequestParam String epxiredIn) {
